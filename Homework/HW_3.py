...
# Но Люба совершила ошибку. Она забыла, что в декабре все работники должны получить зарплату по повышенному
# коэффициенту: 1.5
# А еще у босса есть список любимчиков, которым повышенный коэффициэнт будет 2, их фио нужно выделить высоким
# регистром: они получат зарплату раньше.
...
# people = {1:"Гарри Джеймс Поттер", 2:"Дадли Вернон Дурсль", 3: "Ханна Эббот", 4: "Амелия Боунс",
#            5: "Миллисент Булстроуд", 6: "Финеас Найджелус Блэк", 7: "Аберфорт Дамблдор"}
# cash = {1: 10000, 2: 15000, 3: 5000, 4: 34000, 5: 8000, 6: 46000, 7: 76000}
# for item in cash:
#     item = (item)*1.5
#
# print(cash)

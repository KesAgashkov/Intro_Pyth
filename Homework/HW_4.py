...
#
# print(f'Красивый лист на выходе:{search_uniq_elts([1,2,3,4,3,2,1])}')
...
#
def write_to_file_task_5(strr = 'AAAAAAAAAAAABBBBBBBBBBBCCCCCCCCCCDDDDDDEEEEEFFFFG python is sooooooo coooooool'):
